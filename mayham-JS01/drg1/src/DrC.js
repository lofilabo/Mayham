...
class DrC extends React.Component {
  ...
  buttonClick1(){
    console.log("DrC.jp --> buttonClick1 !!")
    ...
    this.props.onCallableFunction( "1" );
  }

  buttonClick2(){
    console.log("DrC.jp --> buttonClick2 !!")
    //call an Upward function, passing either the stateful message
    //or the initial Property p1
  ...
  buttonClick3(){
    console.log("DrC.jp --> buttonClick3 !!")
    //this.props.onCallableFunction2(this.props.p1);
    this.props.onCallableFunction("FLEEEEEEEEUUUUUUUUUUUUUUUUUUUUUUUUUUUUURRR");
    //this.props.onCallableFunction(this.state.message);
  }
        ...
        <div onFocus={this.gettingFocus}  style={divStyle} className="DottedBox">
          ...
          <div onClick={this.gettingFocus} className="DrContent">
            ...
            <div>{this.props.p1}</div>
                ...
                <div className="Btnz">
                <button className="Btn" onClick={this.buttonClick1}>Button 1</button>
                <button className="Btn" onClick={this.buttonClick2}>Button 2</button>
		
                <button className="Btn" onClick={this.buttonClick3}>Button 3</button>
